...
After start a short introduction for the players shown. The dimensions of the table need to be set, and need to be set 
independently in an arbitrary range of 5 to 8, the width must be greater than the height. The program draws out the game table; 
